    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          variants={fadeInUp}
          whileHover={{ y: -10, transition: { duration: 0.2 } }}
          onClick={() => handleGitHubClick('https://github.com/jmbrathnayke/Weather-Application')}
          style={{ cursor: 'pointer' }}
        >
          <motion.div
            className="project-image"
            style={{ backgroundImage: `url(${weatherAppImage})` }}
            whileHover={{ scale: 1.05, transition: { duration: 0.2 } }}
          />
          <h3>Live Weather App</h3>
          <p>
            Developed a live weather application with real-time data fetching, implementing authentication and authorization for secure access. Built the frontend using React and Tailwind CSS with a dynamic UI for weather information display, and developed the backend with Node.js and Express.js.
          </p>
          <div className="project-tech">
            <span>React.js</span>
          ...
          <div className="project-links">
            <button
              ...
              onClick={(e) => {
                e.stopPropagation(); // Prevent card click
                handleGitHubClick('https://github.com/jmbrathnayke/Weather-Application');
              }}
              style={{ 
                background: 'none', 
                cursor: 'pointer',
